...
//  showmessage(inttostr(os)+'   '+inttostr(MatrixMain.MatrixWidth * MatrixMain.MatrixHeight * MatrixMain.FrameCount) + ' ' + inttostr(lIndexDataSize) +' ' + inttostr(luniqueitems.count));
